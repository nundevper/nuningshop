...
<title>ลืมรหัสผ่าน | <?=$rowSetting['title']?></title>
		...
		<!-- InstanceBeginEditable name="EditRegion_Content_Responsive" -->
         <div class="col-md-9 col-sm-8" id="search-product">
            <div class="col-md-12 col-sm-12 box">
				...
				<form class="col-md-12 col-sm-12 col-xs-12 pay-form" action="process/forgotPassword.php" method="post"> 
                    ...
                    <div class="col-md-10 col-sm-9 col-xs-12">
                    	 <input type="text" name="username" pattern="[0-9a-zA-Zก-๙_-]{3,20}" required autofocus style="width:200px;"/>
                    </div>
                    <div style="clear:both"></div>
                    
                    <div class="col-md-2 col-sm-3 col-xs-12">อีเมล</div>
                    <div class="col-md-10 col-sm-9 col-xs-12">
                    	<input type="text" name="email" maxlength="100" required style="width:200px;"/>
                    </div>
                    <div style="clear:both"></div>
...
<table class="box" border="0" cellspacing="0" cellpadding="10">
  <tr>
    <th style="text-align:left;">ลืมรหัสผ่าน</th>
  </tr>
  <tr>
    <td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
  <tr>
    ...
    <td> <input type="text" name="username" pattern="[0-9a-zA-Zก-๙_-]{3,20}" required autofocus style="width:200px;"/></td>
  </tr>
  <tr>
    <td>อีเมล์</td>
    <td><input type="text" name="email" maxlength="100" required style="width:200px;"/></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
