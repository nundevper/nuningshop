...
<html xmlns="http://www.w3.org/1999/xhtml"><!-- InstanceBegin template="/Templates/font.dwt.php" codeOutsideHTMLIsLocked="false" -->
	<head>
		...
		<?
        $order_id="";
        if(!empty($_GET['order_id'])){$order_id=$_GET['order_id'];}
        ?>
...
<div class="fb-page" data-href="<?=$rowSetting['facebook_fanpage']?>" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true"></div>
        ...
        <div class="col-md-9 col-sm-8 col-xs-12" id="payment">
        	<div class="col-md-12 col-sm-12 col-xs-12 box">
                <h3 class="box-header" style="text-align:left;">แจ้งการชำระเงิน</h3>
                
                <form class="col-md-12 col-sm-12 col-xs-12 pay-form" action="process/payment.php" method="post">
                    <div class="col-md-2 col-sm-3 col-xs-12">รหัสคำสั่งซื้อ</div>
                    <div class="col-md-10 col-sm-9 col-xs-12">
                        <input name="order_id" type="text" style="width:15%;" value="<?=$order_id?>" autofocus/>
                    </div>
                    <div style="clear:both"></div>
                    ...
                    <div class="col-md-10 col-sm-9 col-xs-12">
                        <input type="text" name="fullname" required style="width:40%;"/>
                    </div>
                    <div style="clear:both"></div>
                    ...
                    <div class="col-md-10 col-sm-9 col-xs-12">
                        <input type="text" name="tel" style="width:40%;"/>
                    </div>
                    <div style="clear:both"></div>
                    
                    <div class="col-md-2 col-sm-3 col-xs-12">จำนวนเงิน</div>
                    <div class="col-md-10 col-sm-9 col-xs-12">
                        <input type="text" name="money" placeholder="ไม่ต้องใส่เครื่องหมายลูกน้ำ (,)" required style="width:40%;"/> บาท
                    </div>
                    <div style="clear:both"></div>
                    
                    <div class="col-md-2 col-sm-3 col-xs-12">โอนเข้าธนาคาร</div>
                    <div class="col-md-10 col-sm-9 col-xs-12">
                        <select name="bank" style="width:40%;">
							<?
                            ...
                            for($i=1;$i<=$numBank;$i++){$rowBank=mysql_fetch_array($resultBank);
                              echo"<option value=\"$rowBank[name]\">$rowBank[name]</option>";
                            }
                            ?>
                        </select>
                    </div>
                    ...
                    <div class="col-md-2 col-sm-3 col-xs-12">วันที่โอน</div>
                    <div class="col-md-10 col-sm-9 col-xs-12">
                    ...
                    <div class="col-md-2 col-sm-3 col-xs-12">เวลาที่โอน</div>
                    <div class="col-md-10 col-sm-9 col-xs-12">
                        <select name="hour">
                            <? 
                            for($i=0;$i<=9;$i++){
                   ...
                   <div class="col-md-10 col-sm-9 col-xs-12">
                  		<textarea name="note" rows="5" style="width:80%"></textarea>
                   </div>
                   <div style="clear:both"></div>
                   
                   <div class="col-md-2 col-sm-3 col-xs-12"></div>
                   <div class="col-md-10 col-sm-9 col-xs-12">
                  		<input type="submit" value="แจ้งการชำระเงิน"/>
                   </div>
                   <div style="clear:both"></div>
                   
                </form>
				<?
                $sqlDetail="SELECT * FROM page WHERE name='แจ้งการชำระเงิน'";
