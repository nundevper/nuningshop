...
<title>สมัครสมาชิก | <?=$rowSetting['title']?></title>
...
<div class="fb-page" data-href="<?=$rowSetting['facebook_fanpage']?>" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true"></div>
        ...
        <div class="col-md-9 col-sm-8" id="search-product">
            <div class="col-md-12 col-sm-12 box" style="margin-bottom:20px;">
                <h3 class="box-header" style="text-align:left;">สมัครสมาชิก</h3>

		

                <form class="col-md-12 col-sm-12 col-xs-12 pay-form" action="process/register.php" method="post">

              
                    <div class="col-md-2 col-sm-3 col-xs-12">ชื่อผู้ใช้</div>
                    <div class="col-md-10 col-sm-9 col-xs-12">
                    	<input type="text" name="username" pattern="[a-zA-Z0-9ก-๙_-]{3,20}" placeholder="4-20 ตัว ใช้เครื่องหมาย _ และ - ได้" autofocus required style="width:200px;"/>
                    </div>
                    <div style="clear:both"></div>
                    
                    <div class="col-md-2 col-sm-3 col-xs-12">รหัสผ่าน</div>
                    <div class="col-md-10 col-sm-9 col-xs-12">
                    	<input type="password" name="password" pattern="\S{5,20}" placeholder="6-20 ตัว และไม่มีช่องว่าง" required style="width:200px;"/>
                    </div>
                    <div style="clear:both"></div>
                    ...
                    <div class="col-md-10 col-sm-9 col-xs-12">
                    	<input name="confirm" type="password" pattern="\S{5,20}" required style="width:200px;"/>
                    </div>
                    <div style="clear:both"></div>
                    
                    <div class="col-md-2 col-sm-3 col-xs-12">อีเมล</div>
                    <div class="col-md-10 col-sm-9 col-xs-12">
                    	<input type="text" name="email" required style="width:200px;"/>
                    </div>
                    <div style="clear:both"></div>
                    
                    
                    <div class="col-md-2 col-sm-3 col-xs-12">ชื่อ-นามสกุล</div>
                    <div class="col-md-10 col-sm-9 col-xs-12">
                    	<input type="text" name="fullname" required style="width:200px;"/>
                    </div>
                    <div style="clear:both"></div>
                    
                    <div class="col-md-2 col-sm-3 col-xs-12">วันเกิด</div>
                    <div class="col-md-10 col-sm-9 col-xs-12">
                    	<script>DateInput('birthdate',true,'YYYY-MM-DD')</script>
                    ...
                    <div class="col-md-10 col-sm-9 col-xs-12">
                    	<textarea name="address" required rows="4" style="width:300px;max-width:500px;"></textarea>
                    </div>
                    <div style="clear:both"></div>
                    
                    <div class="col-md-2 col-sm-3 col-xs-12">รหัสไปรษณีย์</div>
                    <div class="col-md-10 col-sm-9 col-xs-12">
                    	<input type="text" name="zipcode" maxlength="10" required style="width:60px;"/>
                    </div>
                    <div style="clear:both"></div>
                    
                    <div class="col-md-2 col-sm-3 col-xs-12">เบอร์ติดต่อ</div>
                    <div class="col-md-10 col-sm-9 col-xs-12">
                    	<input type="text" maxlength="30" name="tel" style="width:200px;"/>
                    </div>
                    <div style="clear:both"></div>
...
<table class="box" border="0" cellspacing="0" cellpadding="10">
  <tr>
    <th class="header" style="text-align:left;">สมัครสมาชิก</th>
  </tr>
  <tr>
    <td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
  <tr>
    ...
    <td><input type="text" name="username" pattern="[a-zA-Z0-9ก-๙_-]{3,20}" placeholder="4-20 ตัว ใช้เครื่องหมาย _ และ - ได้" autofocus required style="width:200px;"/></td>
  </tr>
  <tr>
    <td>รหัสผ่าน</td>
    <td><input type="password" name="password" pattern="\S{5,20}" placeholder="6-20 ตัว และไม่มีช่องว่าง" required style="width:200px;"/></td>
  </tr>
  <tr>
    <td>ยืนยันรหัสผ่าน</td>
    <td><input name="confirm" type="password" pattern="\S{5,20}" required style="width:200px;"/></td>
  </tr>
  <tr>
    <td>อีเมล</td>
  ...
  <tr>
    ...
    <td>ที่อยู่</td>
    <td><textarea name="address" required rows="4" style="width:300px;max-width:500px;"></textarea></td>
  </tr>
  <tr>
    <td>รหัสไปรษณีย์</td>
    <td><input type="text" name="zipcode" maxlength="10" required style="width:60px;"/></td>
  </tr>
  <tr>
    <td width="100">เบอร์ติดต่อ</td>
    <td><input type="text" maxlength="30" name="tel" style="width:200px;"/></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
