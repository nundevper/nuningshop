...
<title>เข้าสู่ระบบ | <?=$rowSetting['title']?></title>
...
<div class="fb-page" data-href="<?=$rowSetting['facebook_fanpage']?>" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true"></div>
        ...
        <div class="col-md-9 col-sm-8" id="search-product">
            <div class="col-md-12 col-sm-12 box">
                <h3 class="box-header" style="text-align:left;">เข้าสู่ระบบ</h3>
			

                <form class="col-md-12 col-sm-12 col-xs-12 pay-form" action="process/login.php" method="post" name="login">
              		<? if(!empty($_REQUEST['register'])){$email=$_GET['register']; ?>
					<div class="col-md-2 col-sm-3 col-xs-12">
                    	ลงทะเบียนผู้ใช้ใหม่เรียบร้อย เพื่อเสร็จสิ้นขั้นตอนการสมัครสมาชิก กรุณาคลิกลิงค์ยืนยันอีเมล์ของคุณที่ <?=$email?>
                	</div>
					<?
                    }
                    if(!empty($_GET['verify'])){$email=$rowSetting['email'];
                    ?>

                    <div class="col-md-2 col-sm-3 col-xs-12">ยืนยันอีเมล์เรียบร้อย หากยังเข้าสู่ระบบไม่ได้ กรุณาติดต่อมาที่ <?=$email?></div>
                    ...
                    <div class="col-md-10 col-sm-9 col-xs-12">
                    	<input type="text" name="member" pattern="[0-9a-zA-Zก-๙_]{3,20}" style="width:200px;"/>
                    </div>
                    <div style="clear:both"></div>
                   ...
                   <div class="col-md-2 col-sm-3 col-xs-12" style="margin-top:0"></div>
                   <div class="col-md-10 col-sm-9 col-xs-12" style="margin-top:0">
                  		<a href="ลืมรหัสผ่าน.html" title="ลืมรหัสผ่าน">ลืมรหัสผ่าน</a>
                   </div>
                   <div style="clear:both"></div>
...
?>
  <tr>
    <td colspan="2">
      <span class="register">ลงทะเบียนผู้ใช้ใหม่เรียบร้อย เพื่อเสร็จสิ้นขั้นตอนการสมัครสมาชิก กรุณาคลิกลิงค์ยืนยันอีเมล์ของคุณที่ <?=$email?></span>
    </td>
  </tr>
<?
}
...
?>
  <tr>
    <td colspan="2">
      <span class="register" style="padding:10px;margin:10px 0 10px 0;width:670px;">ยืนยันอีเมล์เรียบร้อย หากยังเข้าสู่ระบบไม่ได้ กรุณาติดต่อมาที่ <?=$email?></span>
    </td>
  </tr>
<?
}
